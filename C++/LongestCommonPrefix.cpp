...
int main()
{
    ...
    std::cout << "Longest Common Prefix----" << std::endl;
    std::cout << "[flower, flow, flight] : " << s.longestCommonPrefix(data) << std::endl;

    data = { "flower", "flowey", "flow", "flowering" };
    std::cout << "[flower, flowey, flow, flowering] : " << s.longestCommonPrefix(data) << std::endl;

    data = { "dog" , "racecar" , "car"};
    std::cout << "[dog, racecar, car] : " << s.longestCommonPrefix(data) << std::endl;
